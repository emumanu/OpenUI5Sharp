...
sap.ui.define(System.Array.init(["sap/ui/core/Control", "sap/m/RatingIndicator", "sap/m/Label", "sap/m/Button"], System.String), function () {
    var metadata = { properties: function (_o1) {
        ...
        _o3["change"] = TypedMetadata.CreateUI5EventInfo(sap.ui.demo.walkthrough.control.ProductRating.RatingInfo);
        return _o3;
    }({ }) };
    var newObj = Glue.CreateRawClassObject(sap.ui.demo.walkthrough.control.ProductRating, metadata);
