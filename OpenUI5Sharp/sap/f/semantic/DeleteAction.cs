	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class DeleteAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern DeleteAction(string sId, sap.f.semantic.DeleteAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern DeleteAction(sap.f.semantic.DeleteAction.Settings mSettings);
