	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class EditAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern EditAction(string sId, sap.f.semantic.EditAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern EditAction(sap.f.semantic.EditAction.Settings mSettings);
