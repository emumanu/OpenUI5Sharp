	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class ExitFullScreenAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern ExitFullScreenAction(string sId, sap.f.semantic.ExitFullScreenAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new <code>ExitFullScreenAction</code>.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern ExitFullScreenAction(string sId);

					/// <summary>
					/// Constructor for a new <code>ExitFullScreenAction</code>.
					/// </summary>
					public extern ExitFullScreenAction();

					/// <summary>
					/// Constructor for a new <code>ExitFullScreenAction</code>.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern ExitFullScreenAction(sap.f.semantic.ExitFullScreenAction.Settings mSettings);
