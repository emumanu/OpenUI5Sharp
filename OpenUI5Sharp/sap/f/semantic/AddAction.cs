	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class AddAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern AddAction(string sId, sap.f.semantic.AddAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new <code>AddAction</code>.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern AddAction(string sId);

					/// <summary>
					/// Constructor for a new <code>AddAction</code>.
					/// </summary>
					public extern AddAction();

					/// <summary>
					/// Constructor for a new <code>AddAction</code>.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern AddAction(sap.f.semantic.AddAction.Settings mSettings);
