	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class SendEmailAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern SendEmailAction(string sId, sap.f.semantic.SendEmailAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern SendEmailAction(sap.f.semantic.SendEmailAction.Settings mSettings);
