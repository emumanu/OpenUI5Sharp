	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class CopyAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern CopyAction(string sId, sap.f.semantic.CopyAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new <code>CopyAction</code>.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern CopyAction(string sId);

					/// <summary>
					/// Constructor for a new <code>CopyAction</code>.
					/// </summary>
					public extern CopyAction();

					/// <summary>
					/// Constructor for a new <code>CopyAction</code>.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern CopyAction(sap.f.semantic.CopyAction.Settings mSettings);
