	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class MessagesIndicator : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern MessagesIndicator(string sId, sap.f.semantic.MessagesIndicator.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern MessagesIndicator(sap.f.semantic.MessagesIndicator.Settings mSettings);
