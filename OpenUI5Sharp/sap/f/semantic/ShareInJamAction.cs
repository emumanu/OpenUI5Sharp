	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class ShareInJamAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern ShareInJamAction(string sId, sap.f.semantic.ShareInJamAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new <code>ShareInJamAction</code>.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern ShareInJamAction(string sId);

					/// <summary>
					/// Constructor for a new <code>ShareInJamAction</code>.
					/// </summary>
					public extern ShareInJamAction();

					/// <summary>
					/// Constructor for a new <code>ShareInJamAction</code>.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern ShareInJamAction(sap.f.semantic.ShareInJamAction.Settings mSettings);
