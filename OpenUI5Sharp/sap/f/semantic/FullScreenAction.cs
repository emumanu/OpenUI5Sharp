	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class FullScreenAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern FullScreenAction(string sId, sap.f.semantic.FullScreenAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new <code>FullScreenAction</code>.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern FullScreenAction(string sId);

					/// <summary>
					/// Constructor for a new <code>FullScreenAction</code>.
					/// </summary>
					public extern FullScreenAction();

					/// <summary>
					/// Constructor for a new <code>FullScreenAction</code>.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern FullScreenAction(sap.f.semantic.FullScreenAction.Settings mSettings);
