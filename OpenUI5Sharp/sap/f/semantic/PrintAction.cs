	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class PrintAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern PrintAction(string sId, sap.f.semantic.PrintAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern PrintAction(sap.f.semantic.PrintAction.Settings mSettings);
