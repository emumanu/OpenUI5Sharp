	...
	public static partial class sap
	{
		public static partial class f
		{
			public static partial class semantic
			{
				...
				public partial class SendMessageAction : sap.f.semantic.SemanticButton
				{
					#region Settings
					...
					public extern SendMessageAction(string sId, sap.f.semantic.SendMessageAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern SendMessageAction(sap.f.semantic.SendMessageAction.Settings mSettings);
