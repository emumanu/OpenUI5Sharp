		...
		public static partial class ui
		{
			public static partial class layout
			{
				...
				public partial class VerticalLayout : sap.ui.core.Control
				{
					...
					public extern VerticalLayout(string sId, sap.ui.layout.VerticalLayout.Settings mSettings);
					...
					/// </summary>
					/// <param name="sId">Id for the new control, generated automatically if no id is given</param>
					public extern VerticalLayout(string sId);
					...
					/// </summary>
					/// <param name="mSettings">initial settings for the new control</param>
					public extern VerticalLayout(sap.ui.layout.VerticalLayout.Settings mSettings);
					...
					public extern virtual sap.ui.layout.VerticalLayout setWidth(sap.ui.core.CSSSize width);
					...
					public extern virtual sap.ui.layout.VerticalLayout setEnabled(bool bEnabled);
					...
					/// </summary>
					/// <returns>Reference to <code>this</code> in order to allow method chaining</returns>
					public extern virtual sap.ui.layout.VerticalLayout destroyContent();
					...
					/// <returns>Reference to <code>this</code> in order to allow method chaining</returns>
					public extern virtual sap.ui.layout.VerticalLayout insertContent(sap.ui.core.Control oContent, int iIndex);
					...
					/// <returns>Reference to <code>this</code> in order to allow method chaining</returns>
					public extern virtual sap.ui.layout.VerticalLayout addContent(sap.ui.core.Control oContent);
					...
					/// <returns>An object with the accessibilty infos for this control</returns>
