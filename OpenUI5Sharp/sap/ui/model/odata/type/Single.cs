		...
		public static partial class ui
		{
			public static partial class model
			{
				public static partial class odata
				{
					...
					{
						/// <summary>
						/// This class represents the OData primitive type <a href="http://www.odata.org/documentation/odata-version-2-0/overview#AbstractTypeSystem"> <code>Edm.Single</code></a>.
						/// 
						...
						public partial class Single : sap.ui.model.odata.type.ODataType
						{
							#region Constructor
							...
							public extern Single(object oFormatOptions, sap.ui.model.odata.type.ConstraintsInfo oConstraints);

							/// <summary>
							/// Constructor for a primitive type <code>Edm.Single</code>.
							/// </summary>
							/// <param name="oFormatOptions">format options as defined in {@link sap.ui.core.format.NumberFormat}. In contrast to NumberFormat <code>groupingEnabled</code> defaults to <code>true</code>.</param>
							public extern Single(object oFormatOptions);

							/// <summary>
							/// Constructor for a primitive type <code>Edm.Single</code>.
							/// </summary>
							public extern Single();
							...
							/// <summary>
							/// Creates a new subclass of class sap.ui.model.odata.type.Single with name <code>sClassName</code> and enriches it with the information contained in <code>oClassInfo</code>.
							/// 
							...
							public extern virtual Union<int, string> formatValue(Union<string, int> vValue, string sTargetType);
							...
							/// <summary>
							/// Parses the given value, which is expected to be of the given type, to an Edm.Single in <code>number</code> representation.
							/// </summary>
