	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class ShareInJamAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern ShareInJamAction(string sId, sap.m.semantic.ShareInJamAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern ShareInJamAction(sap.m.semantic.ShareInJamAction.Settings mSettings);
