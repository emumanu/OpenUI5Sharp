...
namespace OpenUI5Sharp
{
	public static partial class sap
	{
		public static partial class m
		{
			...
			{
				/// <summary>
				/// A PositiveAction button has default semantic-specific properties and is eligible for aggregation content of a {@link sap.m.semantic.SemanticPage}.
				/// </summary>
				[External]
				[Namespace(false)]
				public partial class PositiveAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern PositiveAction(string sId, sap.m.semantic.PositiveAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">custom initial settings for the new control</param>
					public extern PositiveAction(sap.m.semantic.PositiveAction.Settings mSettings);
					...
					public extern virtual sap.m.semantic.PositiveAction setText(string sText);
					...
					/// <summary>
					/// Creates a new subclass of class sap.m.semantic.PositiveAction with name <code>sClassName</code> and enriches it with the information contained in <code>oClassInfo</code>.
					/// 
