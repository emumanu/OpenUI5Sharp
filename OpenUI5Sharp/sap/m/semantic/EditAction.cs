	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class EditAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern EditAction(string sId, sap.m.semantic.EditAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new EditAction.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern EditAction(string sId);

					/// <summary>
					/// Constructor for a new EditAction.
					/// </summary>
					public extern EditAction();

					/// <summary>
					/// Constructor for a new EditAction.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern EditAction(sap.m.semantic.EditAction.Settings mSettings);
