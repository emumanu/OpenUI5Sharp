	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class ForwardAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern ForwardAction(string sId, sap.m.semantic.ForwardAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new ForwardAction.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern ForwardAction(string sId);

					/// <summary>
					/// Constructor for a new ForwardAction.
					/// </summary>
					public extern ForwardAction();

					/// <summary>
					/// Constructor for a new ForwardAction.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern ForwardAction(sap.m.semantic.ForwardAction.Settings mSettings);
