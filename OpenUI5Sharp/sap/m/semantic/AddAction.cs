	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class AddAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern AddAction(string sId, sap.m.semantic.AddAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern AddAction(sap.m.semantic.AddAction.Settings mSettings);
