	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class NegativeAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern NegativeAction(string sId, sap.m.semantic.NegativeAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">custom initial settings for the new control</param>
					public extern NegativeAction(sap.m.semantic.NegativeAction.Settings mSettings);
					...
					public extern virtual sap.m.semantic.NegativeAction setText(string sText);
