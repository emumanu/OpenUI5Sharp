	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class FavoriteAction : sap.m.semantic.SemanticToggleButton
				{
					#region Settings
					...
					public extern FavoriteAction(string sId, sap.m.semantic.FavoriteAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern FavoriteAction(sap.m.semantic.FavoriteAction.Settings mSettings);
