	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class SendEmailAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern SendEmailAction(string sId, sap.m.semantic.SendEmailAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new SendEmailAction.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern SendEmailAction(string sId);

					/// <summary>
					/// Constructor for a new SendEmailAction.
					/// </summary>
					public extern SendEmailAction();

					/// <summary>
					/// Constructor for a new SendEmailAction.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern SendEmailAction(sap.m.semantic.SendEmailAction.Settings mSettings);
