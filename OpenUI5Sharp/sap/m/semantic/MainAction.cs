	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class MainAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern MainAction(string sId, sap.m.semantic.MainAction.Settings mSettings);
					...
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern MainAction(sap.m.semantic.MainAction.Settings mSettings);
					...
					public extern virtual sap.m.semantic.MainAction setText(string sText);
