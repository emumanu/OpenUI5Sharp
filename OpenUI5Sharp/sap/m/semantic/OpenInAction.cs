	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				[External]
				[Namespace(false)]
				public partial class OpenInAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern OpenInAction(string sId, sap.m.semantic.OpenInAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new OpenInAction.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern OpenInAction(string sId);

					/// <summary>
					/// Constructor for a new OpenInAction.
					/// </summary>
					public extern OpenInAction();

					/// <summary>
					/// Constructor for a new OpenInAction.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern OpenInAction(sap.m.semantic.OpenInAction.Settings mSettings);
