	...
	public static partial class sap
	{
		public static partial class m
		{
			public static partial class semantic
			{
				...
				public partial class SendMessageAction : sap.m.semantic.SemanticButton
				{
					#region Settings
					...
					public extern SendMessageAction(string sId, sap.m.semantic.SendMessageAction.Settings mSettings);

					/// <summary>
					/// Constructor for a new SendMessageAction.
					/// </summary>
					/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
					public extern SendMessageAction(string sId);

					/// <summary>
					/// Constructor for a new SendMessageAction.
					/// </summary>
					public extern SendMessageAction();

					/// <summary>
					/// Constructor for a new SendMessageAction.
					/// </summary>
					/// <param name="mSettings">Custom initial settings for the new control</param>
					public extern SendMessageAction(sap.m.semantic.SendMessageAction.Settings mSettings);
