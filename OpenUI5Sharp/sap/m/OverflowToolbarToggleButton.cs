...
namespace OpenUI5Sharp
{
	public static partial class sap
	{
		public static partial class m
		{
			...
			[External]
			[Namespace(false)]
			public partial class OverflowToolbarToggleButton : sap.m.ToggleButton
			{
				#region Settings
				...
				[External]
				[ObjectLiteral]
				public partial class Settings : sap.m.ToggleButton.Settings
				{
				}
				...
				public extern OverflowToolbarToggleButton(string sId, sap.m.OverflowToolbarToggleButton.Settings mSettings);

				/// <summary>
				/// Constructor for a new <code>OverflowToolbarToggleButton</code>.
				/// </summary>
				/// <param name="sId">ID for the new control, generated automatically if no ID is given</param>
				public extern OverflowToolbarToggleButton(string sId);

				/// <summary>
				/// Constructor for a new <code>OverflowToolbarToggleButton</code>.
				/// </summary>
				public extern OverflowToolbarToggleButton();

				/// <summary>
				/// Constructor for a new <code>OverflowToolbarToggleButton</code>.
				/// </summary>
				/// <param name="mSettings">Initial settings for the new control</param>
				public extern OverflowToolbarToggleButton(sap.m.OverflowToolbarToggleButton.Settings mSettings);
