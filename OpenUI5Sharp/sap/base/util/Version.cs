		...
		public static partial class @base
		{
			public static partial class util
			{
				...
				public partial class Version
				{
					...
					public extern Version(Union<int, string, object[], sap.@base.util.Version> vMajor, int iMinor, int iPatch, string sSuffix);
					...
					/// 
					/// The boundaries against which this version should be checked can be given as <code>sap.base.util.Version</code> instances (e.g. <code>v.inRange(v1, v2)</code>), as strings (e.g. <code>v.inRange("1.4", "2.7")</code>) or as arrays (e.g. <code>v.inRange([1,4], [2,7])</code>).
					/// </summary>
					...
					public extern virtual bool inRange(Union<string, object[], sap.@base.util.Version> vMin, Union<string, object[], sap.@base.util.Version> vMax);
