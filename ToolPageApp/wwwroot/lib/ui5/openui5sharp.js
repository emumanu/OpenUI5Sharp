...
Bridge.assembly("OpenUI5Sharp", function ($asm, globals) {
        ...
        statics: {
            methods: {
                ...
                getParameterFor: function (TParameter, TValue, event, pathExpression) {
                    var sPropertyName = UI5.Extensions.ExpressionEvaluator.GetPath(Bridge.global.Function, pathExpression);
        ...
        statics: {
            methods: {
                ...
                getPropertyFor: function (TModel, TValue, context, pathExpression, absolutePath) {
                    ...
                    var sPropertyName = System.String.format("{0}{1}", pref, UI5.Extensions.ExpressionEvaluator.GetPath(Bridge.global.Function, pathExpression));
    ...
    Bridge.define("UI5.Glue", {
        $metadata : function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"CreateRawClassObject","is":true,"t":8,"pi":[{"n":"ctorParamTypes","dv":null,"o":true,"pt":System.Array.type(Function),"ps":0}],"tpc":1,"tprm":["T"],"sn":"CreateRawClassObject","rt":System.Object,"p":[System.Array.type(Function)]},{"a":2,"n":"IsNullOrUndefined","is":true,"t":8,"pi":[{"n":"val","pt":System.Object,"ps":0}],"sn":"IsNullOrUndefined","rt":System.Boolean,"p":[System.Object],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"ToBoolean","is":true,"t":8,"pi":[{"n":"val","pt":System.Object,"ps":0}],"sn":"ToBoolean","rt":System.Boolean,"p":[System.Object],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; },
        statics: {
            methods: {
                /**
                ...
                CreateRawClassObject: function (T, ctorParamTypes) {
                    var $t;
                    ...
                    // if there are parameters for a specific constructor, find a matching one
                    ...
                    // adds the constructor if a specific one was present
                    if ($constructor != null) {
